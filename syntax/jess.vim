...
"
"
" Slightly modified by Mattia Vinci to include some new features
...
syn keyword jessFunc    halt	    if	      implode$  then    else
...
syn keyword jessFunc    rest$	    retract	      retract-string    remove
...
syn keyword jessFunc    declare variables   

" jess Keywords (modifiers)
syn keyword jessKey	    defglobal	  deffunction	    defrule deftemplate
syn keyword jessKey	    deffacts    defquery
...
syn region jessDebug start="(debug" end=")"
...
syn keyword jessConstant  nil   slot
syn keyword jessConstant  <-

syn keyword jessBoolean  TRUE  FALSE
...
if version >= 508 || !exists("did_jess_syntax_inits")
  ...
  HiLink jessDeclaration	Keyword
  HiLink jessFunc		Statement
  HiLink jessKey		Define
  ...
  HiLink jessBoolean    Boolean
  HiLink jessDebug  Debug
  HiLink jessOperator Operator
